...
CREATE TABLE "new_Preset" (
    ...
    "webSearchModel" TEXT NOT NULL DEFAULT 'gpt-3.5-turbo',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_Preset" ("advancedModeMessageDelay", "allowImageInput", "allowVoiceOutput", "allowWebSearch", "atTriggered", "botFuzzyMatchEnabled", "botName", "botNicknames", "chatHistoryLimit", "content", "createdAt", "id", "messageHistoryLimit", "mode", "name", "nameTriggered", "nicknameTriggered", "openaiApiKey", "openaiBaseUrl", "openaiModel", "replyTriggered", "updatedAt") SELECT "advancedModeMessageDelay", "allowImageInput", "allowVoiceOutput", "allowWebSearch", "atTriggered", "botFuzzyMatchEnabled", "botName", "botNicknames", "chatHistoryLimit", "content", "createdAt", "id", "messageHistoryLimit", "mode", "name", "nameTriggered", "nicknameTriggered", "openaiApiKey", "openaiBaseUrl", "openaiModel", "replyTriggered", "updatedAt" FROM "Preset";
DROP TABLE "Preset";
...
INSERT INTO "new_disguise_presets" ("advancedModeMessageDelay", "allowImageInput", "allowVoiceOutput", "allowWebSearch", "atTriggered", "botFuzzyMatchEnabled", "botName", "botNicknames", "chatHistoryLimit", "content", "createdAt", "id", "messageHistoryLimit", "mode", "name", "nameTriggered", "nicknameTriggered", "openaiApiKey", "openaiBaseUrl", "openaiModel", "replyTriggered", "updatedAt") SELECT "advancedModeMessageDelay", "allowImageInput", "allowVoiceOutput", "allowWebSearch", "atTriggered", "botFuzzyMatchEnabled", "botName", "botNicknames", "chatHistoryLimit", "content", "createdAt", "id", "messageHistoryLimit", "mode", "name", "nameTriggered", "nicknameTriggered", "openaiApiKey", "openaiBaseUrl", "openaiModel", "replyTriggered", "updatedAt" FROM "disguise_presets";
