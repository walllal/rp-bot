...
INSERT INTO "new_Preset" ("advancedModeMessageDelay", "allowImageInput", "allowVoiceOutput", "atTriggered", "botFuzzyMatchEnabled", "botName", "botNicknames", "chatHistoryLimit", "content", "createdAt", "id", "messageHistoryLimit", "mode", "name", "nameTriggered", "nicknameTriggered", "openaiApiKey", "openaiBaseUrl", "openaiModel", "replyTriggered", "updatedAt") SELECT "advancedModeMessageDelay", "allowImageInput", "allowVoiceOutput", "atTriggered", "botFuzzyMatchEnabled", "botName", "botNicknames", "chatHistoryLimit", "content", "createdAt", "id", "messageHistoryLimit", "mode", "name", "nameTriggered", "nicknameTriggered", "openaiApiKey", "openaiBaseUrl", "openaiModel", "replyTriggered", "updatedAt" FROM "Preset";
DROP TABLE "Preset";
...
INSERT INTO "new_disguise_presets" ("advancedModeMessageDelay", "allowImageInput", "allowVoiceOutput", "atTriggered", "botFuzzyMatchEnabled", "botName", "botNicknames", "chatHistoryLimit", "content", "createdAt", "id", "messageHistoryLimit", "mode", "name", "nameTriggered", "nicknameTriggered", "openaiApiKey", "openaiBaseUrl", "openaiModel", "replyTriggered", "updatedAt") SELECT "advancedModeMessageDelay", "allowImageInput", "allowVoiceOutput", "atTriggered", "botFuzzyMatchEnabled", "botName", "botNicknames", "chatHistoryLimit", "content", "createdAt", "id", "messageHistoryLimit", "mode", "name", "nameTriggered", "nicknameTriggered", "openaiApiKey", "openaiBaseUrl", "openaiModel", "replyTriggered", "updatedAt" FROM "disguise_presets";
