...
INSERT INTO "new_app_settings" ("createdAt", "disguiseFeatureEnabled", "groupBlacklistEnabled", "groupWhitelistEnabled", "id", "logLevel", "onebotAccessToken", "onebotMode", "onebotPort", "onebotReconnectInterval", "onebotUrl", "presetFeatureEnabled", "privateBlacklistEnabled", "privateWhitelistEnabled", "updatedAt") SELECT "createdAt", "disguiseFeatureEnabled", "groupBlacklistEnabled", "groupWhitelistEnabled", "id", "logLevel", "onebotAccessToken", "onebotMode", "onebotPort", "onebotReconnectInterval", "onebotUrl", "presetFeatureEnabled", "privateBlacklistEnabled", "privateWhitelistEnabled", "updatedAt" FROM "app_settings";
