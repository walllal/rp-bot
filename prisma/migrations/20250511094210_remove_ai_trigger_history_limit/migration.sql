/*
  ...
  - You are about to drop the column `aiTriggerHistoryLimit` on the `Preset` table. All the data in the column will be lost.
  - You are about to drop the column `aiTriggerHistoryLimit` on the `disguise_presets` table. All the data in the column will be lost.
...
INSERT INTO "new_disguise_presets" ("advancedModeMessageDelay", "aiTriggerApiKey", "aiTriggerBaseUrl", "aiTriggerEnabled", "aiTriggerKeyword", "aiTriggerKeywordFuzzyMatch", "aiTriggerModel", "aiTriggerSystemPrompt", "aiTriggerUserPrompt", "allowImageInput", "allowVoiceOutput", "allowWebSearch", "atTriggered", "botFuzzyMatchEnabled", "botName", "botNicknames", "chatHistoryLimit", "content", "createdAt", "id", "messageHistoryLimit", "mode", "name", "nameTriggered", "nicknameTriggered", "openaiApiKey", "openaiBaseUrl", "openaiModel", "quantitativeTriggerEnabled", "quantitativeTriggerThreshold", "replyTriggered", "timedTriggerEnabled", "timedTriggerInterval", "updatedAt", "webSearchApiKey", "webSearchBaseUrl", "webSearchModel", "webSearchSystemPrompt") SELECT "advancedModeMessageDelay", "aiTriggerApiKey", "aiTriggerBaseUrl", "aiTriggerEnabled", "aiTriggerKeyword", "aiTriggerKeywordFuzzyMatch", "aiTriggerModel", "aiTriggerSystemPrompt", "aiTriggerUserPrompt", "allowImageInput", "allowVoiceOutput", "allowWebSearch", "atTriggered", "botFuzzyMatchEnabled", "botName", "botNicknames", "chatHistoryLimit", "content", "createdAt", "id", "messageHistoryLimit", "mode", "name", "nameTriggered", "nicknameTriggered", "openaiApiKey", "openaiBaseUrl", "openaiModel", "quantitativeTriggerEnabled", "quantitativeTriggerThreshold", "replyTriggered", "timedTriggerEnabled", "timedTriggerInterval", "updatedAt", "webSearchApiKey", "webSearchBaseUrl", "webSearchModel", "webSearchSystemPrompt" FROM "disguise_presets";
